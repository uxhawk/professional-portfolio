...
This is one of four Precedent case studies — Law Firm AI Ecosystem. For the AI Document Authoring, see [AI Document Authoring](/ux-projects/ai-document-authoring/); for the onboarding flow, see [AI Ecosystem Onboarding](/ux-projects/ai-ecosystem-onboarding/); for data review flow, see [Human-in-the-loop AI Review](/ux-projects/human-in-the-loop-ai-review/).
