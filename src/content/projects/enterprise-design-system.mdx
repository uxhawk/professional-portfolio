...
<Carousel
  fit="cover"
  images={[
    { src: "/images/2026/04/09_Navigation.png", alt: "Global application shell — navigation standards" },
  ]}
/>
...
<Carousel
  fit="cover"
  images={[
    { src: "/images/2026/04/05_Logos.png", alt: "Application switcher — product logos and brand hierarchy" },
  ]}
/>
...
<Carousel
  fit="cover"
  images={[
    { src: "/images/2026/04/08_Layout.png", alt: "Information architecture — layout and page structure standards" },
  ]}
/>
...
<Carousel
  fit="cover"
  images={[
    { src: "/images/2026/04/022_Notifications.png", alt: "Cross-application UX contracts — notification architecture" },
  ]}
/>
...
<Carousel
  fit="cover"
  images={[
    { src: "/images/2026/04/015_Data-tables.png", alt: "Workflow context — data tables with embedded status indicators" },
    { src: "/images/2026/04/023_Tags.png", alt: "Workflow context — status tags and pills" },
  ]}
/>
...
<Carousel
  fit="cover"
  images={[
    { src: "/images/2026/04/02_Typography-Vocabulary.png", alt: "Foundation layer — typography and vocabulary" },
    { src: "/images/2026/04/03_Colors_-General.png", alt: "Foundation layer — color system" },
    { src: "/images/2026/04/018_Buttons.png", alt: "Foundation layer — button states" },
    { src: "/images/2026/04/017_Forms.png", alt: "Foundation layer — form fields and states" },
  ]}
/>
